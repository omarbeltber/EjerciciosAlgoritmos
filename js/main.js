...
let x2 = prompt("Pon el segundo número");
if(x2< 1 || x2 >100){
    alert("Pon nuevamente");
    let x2 = prompt("Pon el segundo número");
}
...
if((x1 < x2) && (x1 < x3)){
    ...
    alert("El número más chico es" + x2);
}
else{
...
let y2 = prompt("Pon el segundo número");
if(y2< 1 || y2 >100){
    alert("Pon nuevamente");
    let y2 = prompt("Pon el segundo número");
}
...
if((y1 > y2) && (y1 > y3)){
    ...
    alert("El número más grande es" + y2);
}
else{
...
if((z1 % 3) == 0){
    alert("Si es multiplo de 3, Su Número " + z1);
}
...
if((x1 + x2) == x3) {
    ...
    alert(x2 + " Es la suma de los otros dos números");
}
else if((x2 + x3) == x1) {
    alert(x1 + " Es la suma de los otros dos números");
}
else{
